...
-- difference between 2 samples at 48000 Hz and 8191 range
    ...
    begin
        case to_integer(unsigned(midi_note_code)) is
            ...
            when 21 =>
                ...
                note_linear_diff <= to_unsigned(5, note_linear_diff'length);
            ...
            when 24 =>
                ...
                note_linear_diff <= to_unsigned(6, note_linear_diff'length);
            ...
            when 27 =>
                ...
                note_linear_diff <= to_unsigned(7, note_linear_diff'length);
            ...
            when 30 =>
                ...
                note_linear_diff <= to_unsigned(8, note_linear_diff'length);
            ...
            when 32 =>
                ...
                note_linear_diff <= to_unsigned(9, note_linear_diff'length);
            ...
            when 34 =>
                ...
                note_linear_diff <= to_unsigned(10, note_linear_diff'length);

            when 35 =>
                -- Note code 35 is B1 at 61.74 Hz
                note_linear_diff <= to_unsigned(11, note_linear_diff'length);
            ...
            when 37 =>
                ...
                note_linear_diff <= to_unsigned(12, note_linear_diff'length);

            when 38 =>
                -- Note code 38 is D2 at 73.42 Hz
                note_linear_diff <= to_unsigned(13, note_linear_diff'length);
            ...
            when 40 =>
                ...
                note_linear_diff <= to_unsigned(14, note_linear_diff'length);

            when 41 =>
                -- Note code 41 is F2 at 87.31 Hz
                note_linear_diff <= to_unsigned(15, note_linear_diff'length);

            when 42 =>
                -- Note code 42 is F#2 at 92.5 Hz
                note_linear_diff <= to_unsigned(16, note_linear_diff'length);

            when 43 =>
                -- Note code 43 is G2 at 98.0 Hz
                note_linear_diff <= to_unsigned(17, note_linear_diff'length);

            when 44 =>
                -- Note code 44 is G#2 at 103.83 Hz
                note_linear_diff <= to_unsigned(18, note_linear_diff'length);

            when 45 =>
                -- Note code 45 is A2 at 110.0 Hz
                note_linear_diff <= to_unsigned(19, note_linear_diff'length);

            when 46 =>
                -- Note code 46 is A#2 at 116.54 Hz
                note_linear_diff <= to_unsigned(20, note_linear_diff'length);

            when 47 =>
                -- Note code 47 is B2 at 123.47 Hz
                note_linear_diff <= to_unsigned(21, note_linear_diff'length);

            when 48 =>
                -- Note code 48 is C3 at 130.81 Hz
                note_linear_diff <= to_unsigned(22, note_linear_diff'length);

            when 49 =>
                -- Note code 49 is C#3 at 138.59 Hz
                note_linear_diff <= to_unsigned(24, note_linear_diff'length);

            when 50 =>
                -- Note code 50 is D3 at 146.83 Hz
                note_linear_diff <= to_unsigned(25, note_linear_diff'length);

            when 51 =>
                -- Note code 51 is D#3 at 155.56 Hz
                note_linear_diff <= to_unsigned(27, note_linear_diff'length);

            when 52 =>
                -- Note code 52 is E3 at 164.81 Hz
                note_linear_diff <= to_unsigned(28, note_linear_diff'length);

            when 53 =>
                -- Note code 53 is F3 at 174.61 Hz
                note_linear_diff <= to_unsigned(30, note_linear_diff'length);

            when 54 =>
                -- Note code 54 is F#3 at 185.0 Hz
                note_linear_diff <= to_unsigned(32, note_linear_diff'length);

            when 55 =>
                -- Note code 55 is G3 at 196.0 Hz
                note_linear_diff <= to_unsigned(33, note_linear_diff'length);

            when 56 =>
                -- Note code 56 is G#3 at 207.65 Hz
                note_linear_diff <= to_unsigned(35, note_linear_diff'length);
            ...
            when 76 =>
                ...
                note_linear_diff <= to_unsigned(112, note_linear_diff'length);
            ...
            when 92 =>
                ...
                note_linear_diff <= to_unsigned(283, note_linear_diff'length);
